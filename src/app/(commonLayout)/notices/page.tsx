    ...
    <div className="flex flex-col w-full font-roboto min-h-screen bg-[#f1f1f1]">
      ...
      <section className="w-full py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-0 max-w-[1140px]">
          <div className="bg-white border-t-[3px] border-t-[#575757] rounded-[10px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.15)] p-[20px] md:p-[50px] w-full min-h-[400px]">
            {/* Header Title */}
            <div className="mb-6">
            ...
            <div className="flex flex-col gap-3">
              {noticesData.map((notice) => (
                ...
                >
                  {/* Date Block */}
                  <div className="flex flex-col items-center justify-center bg-[#1b2032] border-r border-gray-600 px-4 md:px-6 py-3 min-w-[70px] md:min-w-[90px] shrink-0">
                    <span className="text-[18px] md:text-[20px] font-bold leading-none">
                      {notice.day}
                    </span>
                    <span className="text-[12px] md:text-[14px] font-medium mt-1 uppercase">
                      {notice.month}
                    </span>
                  </div>
