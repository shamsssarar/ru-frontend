...
const appmathNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Applied Mathematics: Workshop on Documentation and Evidences",
    link: "/academic/department/appmath/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/appmath/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/appmath/notices/3",
  },
];
...
const appmathEvents = [
  {
    ...
    link: "/academic/department/appmath/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/appmath/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/appmath/events/3",
  },
];

const appmathFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/appmath/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/appmath/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/appmath/ex-chairmans",
      },
      { text: "About", url: "/academic/department/appmath/about" },
      { text: "Contact", url: "/academic/department/appmath/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/appmath/iqac" },
      { text: "Thesis", url: "/academic/department/appmath/thesis" },
      { text: "Committee", url: "/academic/department/appmath/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/appmath/faculty-members",
      },
      { text: "Officers", url: "/academic/department/appmath/officers" },
      { text: "Staff List", url: "/academic/department/appmath/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/appmath/journal",
      },
      { text: "Alumni", url: "/academic/department/appmath/alumni" },
      { text: "Rules & Forms", url: "/academic/department/appmath/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/appmath/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/appmath/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/appmath/notices" },
      { text: "Events", url: "/academic/department/appmath/events" },
      { text: "Programs", url: "/academic/department/appmath/programs" },
      { text: "Photo Gallery", url: "/academic/department/appmath/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/appmath/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/appmath/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/appmath/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/appmath/routine",
      },
    ],
  },
  {
...
export default function AppliedMathematicsDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Applied Mathematics"
      ...
      profileLink="/academic/department/appmath/profile"
      notices={appmathNotices}
      events={appmathEvents}
      departmentName="Department of Applied Mathematics"
      footerColumns={appmathFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Applied Mathematics is one of the oldest departments in
          ...
          <p>
            The department of applied mathematics has an excellent faculty strength
