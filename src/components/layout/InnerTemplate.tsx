    ...
    <div className="flex flex-col w-full font-roboto">
      ...
      <section className="w-full bg-gray-50 py-12 md:py-16">
        <div className="container mx-auto px-4 md:px-0 max-w-[1140px]">
          ...
          <h2 className="text-center text-[28px] md:text-[36px] font-bold text-black uppercase mb-10 tracking-wider">
            {pageTitle}
          </h2>
          ...
          */}
          <div className="bg-white border-t-[3px] border-t-[#d32f2f] rounded-b-[15px] shadow-[0_0_15px_rgba(0,0,0,0.08)] p-6 md:p-10">
            {/* The Responsive Grid */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
              {items.map((item, index) => (
                ...
                >
                  <Link
                    href={item.link}
                    className="group flex items-center bg-white border border-[#e3e3e3] rounded-[5px] p-[10px] min-h-[118px] overflow-hidden transition-all duration-[400ms] ease-in-out hover:-translate-y-2 hover:shadow-[0_8px_20px_rgba(0,0,0,0.5)] hover:border-gray-300 animate-in fade-in slide-in-from-bottom-4"
                    style={{
                  ...
                  >
                    ...
                    <div className="relative w-[110px] md:w-[140px] h-[80px] shrink-0 bg-white rounded-[3px] overflow-hidden">
                      <Image
                        src={item.image}
                        alt={item.title}
                        fill
                    ...
                    */}
                    <div className="flex items-center px-4 md:px-6 flex-1">
                      <h3 className="text-[14px] md:text-[16px] font-roboto font-normal text-[#333333] leading-[21px] group-hover:text-[#0055A5] transition-colors duration-[400ms]">
                        {item.title}
                      </h3>
                    </div>
                  </Link>
