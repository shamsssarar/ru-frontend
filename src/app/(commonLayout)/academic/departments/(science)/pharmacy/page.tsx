...
const pharmacyNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Pharmacy: Workshop on Documentation and Evidences",
    link: "/academic/department/pharmacy/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/pharmacy/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/pharmacy/notices/3",
  },
];
...
const pharmacyEvents = [
  {
    ...
    link: "/academic/department/pharmacy/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/pharmacy/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/pharmacy/events/3",
  },
];

const pharmacyFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/pharmacy/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/pharmacy/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/pharmacy/ex-chairmans",
      },
      { text: "About", url: "/academic/department/pharmacy/about" },
      { text: "Contact", url: "/academic/department/pharmacy/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/pharmacy/iqac" },
      { text: "Thesis", url: "/academic/department/pharmacy/thesis" },
      { text: "Committee", url: "/academic/department/pharmacy/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/pharmacy/faculty-members",
      },
      { text: "Officers", url: "/academic/department/pharmacy/officers" },
      { text: "Staff List", url: "/academic/department/pharmacy/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/pharmacy/journal",
      },
      { text: "Alumni", url: "/academic/department/pharmacy/alumni" },
      { text: "Rules & Forms", url: "/academic/department/pharmacy/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/pharmacy/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/pharmacy/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/pharmacy/notices" },
      { text: "Events", url: "/academic/department/pharmacy/events" },
      { text: "Programs", url: "/academic/department/pharmacy/programs" },
      { text: "Photo Gallery", url: "/academic/department/pharmacy/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/pharmacy/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/pharmacy/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/pharmacy/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/pharmacy/routine",
      },
    ],
  },
  {
...
export default function PharmacyDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Pharmacy"
      ...
      profileLink="/academic/department/pharmacy/profile"
      notices={pharmacyNotices}
      events={pharmacyEvents}
      departmentName="Department of Pharmacy"
      footerColumns={pharmacyFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Pharmacy is one of the oldest departments in
          ...
          <p>
            The department of pharmacy has an excellent faculty strength
