...
const anthropologyNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Anthropology: Workshop on Documentation and Evidences",
    link: "/academic/department/anthropology/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/anthropology/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/anthropology/notices/3",
  },
];

const anthropologyEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/anthropology/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/anthropology/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/anthropology/events/3",
  },
];

const anthropologyFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/anthropology/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/anthropology/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/anthropology/ex-chairmans",
      },
      { text: "About", url: "/academic/department/anthropology/about" },
      { text: "Contact", url: "/academic/department/anthropology/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/anthropology/iqac" },
      { text: "Thesis", url: "/academic/department/anthropology/thesis" },
      { text: "Committee", url: "/academic/department/anthropology/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/anthropology/faculty-members",
      },
      { text: "Officers", url: "/academic/department/anthropology/officers" },
      { text: "Staff List", url: "/academic/department/anthropology/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/anthropology/journal",
      },
      { text: "Alumni", url: "/academic/department/anthropology/alumni" },
      { text: "Rules & Forms", url: "/academic/department/anthropology/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/anthropology/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/anthropology/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/anthropology/notices" },
      { text: "Events", url: "/academic/department/anthropology/events" },
      { text: "Programs", url: "/academic/department/anthropology/programs" },
      { text: "Photo Gallery", url: "/academic/department/anthropology/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/anthropology/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/anthropology/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/anthropology/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/anthropology/routine",
      },
    ],
  },
  {
...
export default function AnthropologyDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Anthropology"
      ...
      profileLink="/academic/department/anthropology/profile"
      notices={anthropologyNotices}
      events={anthropologyEvents}
      departmentName="Department of Anthropology"
      footerColumns={anthropologyFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Anthropology is one of the oldest departments in
          ...
          <p>
            The department of anthropology has an excellent faculty strength
