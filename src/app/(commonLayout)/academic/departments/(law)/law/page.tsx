...
const lawNotices = [
  {
    ...
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Law: Workshop on Documentation and Evidences",
    link: "/academic/department/law/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/law/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/law/notices/3",
  },
];
...
const lawEvents = [
  {
    ...
    link: "/academic/department/law/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/law/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/law/events/3",
  },
];
...
const lawFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/law/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/law/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/law/ex-chairmans",
      },
      { text: "About", url: "/academic/department/law/about" },
      { text: "Contact", url: "/academic/department/law/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/law/iqac" },
      { text: "Thesis", url: "/academic/department/law/thesis" },
      { text: "Committee", url: "/academic/department/law/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/law/faculty-members",
      },
      { text: "Officers", url: "/academic/department/law/officers" },
      { text: "Staff List", url: "/academic/department/law/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/law/journal",
      },
      { text: "Alumni", url: "/academic/department/law/alumni" },
      { text: "Rules & Forms", url: "/academic/department/law/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/law/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/law/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/law/notices" },
      { text: "Events", url: "/academic/department/law/events" },
      { text: "Programs", url: "/academic/department/law/programs" },
      { text: "Photo Gallery", url: "/academic/department/law/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/law/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/law/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/law/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/law/routine",
      },
    ],
  },
  {
...
export default function LawDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Law"
      ...
      profileLink="/academic/department/law/profile"
      notices={lawNotices}
      events={lawEvents}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Law is one of the oldest departments in
          ...
          <p>
            The department of law has an excellent faculty strength
