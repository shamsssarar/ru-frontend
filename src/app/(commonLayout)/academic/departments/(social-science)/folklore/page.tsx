...
const folkloreNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Folklore: Workshop on Documentation and Evidences",
    link: "/academic/department/folklore/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/folklore/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/folklore/notices/3",
  },
];
...
const folkloreEvents = [
  {
    ...
    link: "/academic/department/folklore/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/folklore/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/folklore/events/3",
  },
];

const folkloreFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/folklore/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/folklore/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/folklore/ex-chairmans",
      },
      { text: "About", url: "/academic/department/folklore/about" },
      { text: "Contact", url: "/academic/department/folklore/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/folklore/iqac" },
      { text: "Thesis", url: "/academic/department/folklore/thesis" },
      { text: "Committee", url: "/academic/department/folklore/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/folklore/faculty-members",
      },
      { text: "Officers", url: "/academic/department/folklore/officers" },
      { text: "Staff List", url: "/academic/department/folklore/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/folklore/journal",
      },
      { text: "Alumni", url: "/academic/department/folklore/alumni" },
      { text: "Rules & Forms", url: "/academic/department/folklore/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/folklore/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/folklore/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/folklore/notices" },
      { text: "Events", url: "/academic/department/folklore/events" },
      { text: "Programs", url: "/academic/department/folklore/programs" },
      { text: "Photo Gallery", url: "/academic/department/folklore/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/folklore/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/folklore/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/folklore/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/folklore/routine",
      },
    ],
  },
  {
...
export default function FolkloreDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Folklore"
      ...
      profileLink="/academic/department/folklore/profile"
      notices={folkloreNotices}
      events={folkloreEvents}
      departmentName="Department of Folklore"
      footerColumns={folkloreFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Folklore is one of the oldest departments in
          ...
          <p>
            The department of folklore has an excellent faculty strength
