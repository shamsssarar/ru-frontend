      ...
      <div className="container mx-auto px-4 md:px-0 max-w-[1140px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          {footerData.map((column, index) => (
            <div key={index} className="flex flex-col">
              ...
              <h3 className="text-[18px] md:text-[20px] font-bold mb-4 pb-3 border-b border-gray-700/60 text-white">
                {column.title}
              </h3>
              ...
              <ul className="flex flex-col gap-2.5">
                {column.links.map((link, linkIndex) => (
                  <li key={linkIndex} className="flex items-center">
                    ...
                    <Link
                      href="#"
                      className="text-[14px] text-gray-300 hover:text-[#e83e8c] transition-colors duration-200"
                    >
                      {link}
                    </Link>
                  </li>
        ...
        <div className="border-t border-gray-800/80 pt-6 flex justify-center text-center">
          <p className="text-[14px] text-gray-400 font-medium">
            All rights reserved &copy; 2026, University of Rajshahi. Powered by ICT Center, RU.
          </p>
        </div>
