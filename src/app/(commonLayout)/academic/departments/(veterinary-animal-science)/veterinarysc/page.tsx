...
const veterinaryscNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Veterinary and Animal Sciences: Workshop on Documentation and Evidences",
    link: "/academic/department/veterinarysc/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/veterinarysc/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/veterinarysc/notices/3",
  },
];

const veterinaryscEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/veterinarysc/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/veterinarysc/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/veterinarysc/events/3",
  },
];

const veterinaryscFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/veterinarysc/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/veterinarysc/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/veterinarysc/ex-chairmans",
      },
      { text: "About", url: "/academic/department/veterinarysc/about" },
      { text: "Contact", url: "/academic/department/veterinarysc/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/veterinarysc/iqac" },
      { text: "Thesis", url: "/academic/department/veterinarysc/thesis" },
      { text: "Committee", url: "/academic/department/veterinarysc/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/veterinarysc/faculty-members",
      },
      { text: "Officers", url: "/academic/department/veterinarysc/officers" },
      { text: "Staff List", url: "/academic/department/veterinarysc/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/veterinarysc/journal",
      },
      { text: "Alumni", url: "/academic/department/veterinarysc/alumni" },
      { text: "Rules & Forms", url: "/academic/department/veterinarysc/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/veterinarysc/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/veterinarysc/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/veterinarysc/notices" },
      { text: "Events", url: "/academic/department/veterinarysc/events" },
      { text: "Programs", url: "/academic/department/veterinarysc/programs" },
      { text: "Photo Gallery", url: "/academic/department/veterinarysc/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/veterinarysc/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/veterinarysc/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/veterinarysc/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/veterinarysc/routine",
      },
    ],
  },
  {
...
export default function VeterinaryandAnimalSciencesDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Veterinary and Animal Sciences"
      ...
      profileLink="/academic/department/veterinarysc/profile"
      notices={veterinaryscNotices}
      events={veterinaryscEvents}
      departmentName="Department of Veterinary and Animal Sciences"
      footerColumns={veterinaryscFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Veterinary and Animal Sciences is one of the oldest departments in
          ...
          <p>
            The department of veterinary and animal sciences has an excellent faculty strength
