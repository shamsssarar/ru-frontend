...
const sociologyNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Sociology: Workshop on Documentation and Evidences",
    link: "/academic/department/sociology/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/sociology/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/sociology/notices/3",
  },
];

const sociologyEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/sociology/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/sociology/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/sociology/events/3",
  },
];

const sociologyFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/sociology/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/sociology/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/sociology/ex-chairmans",
      },
      { text: "About", url: "/academic/department/sociology/about" },
      { text: "Contact", url: "/academic/department/sociology/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/sociology/iqac" },
      { text: "Thesis", url: "/academic/department/sociology/thesis" },
      { text: "Committee", url: "/academic/department/sociology/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/sociology/faculty-members",
      },
      { text: "Officers", url: "/academic/department/sociology/officers" },
      { text: "Staff List", url: "/academic/department/sociology/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/sociology/journal",
      },
      { text: "Alumni", url: "/academic/department/sociology/alumni" },
      { text: "Rules & Forms", url: "/academic/department/sociology/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/sociology/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/sociology/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/sociology/notices" },
      { text: "Events", url: "/academic/department/sociology/events" },
      { text: "Programs", url: "/academic/department/sociology/programs" },
      { text: "Photo Gallery", url: "/academic/department/sociology/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/sociology/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/sociology/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/sociology/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/sociology/routine",
      },
    ],
  },
  {
...
export default function SociologyDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Sociology"
      ...
      profileLink="/academic/department/sociology/profile"
      notices={sociologyNotices}
      events={sociologyEvents}
      departmentName="Department of Sociology"
      footerColumns={sociologyFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Sociology is one of the oldest departments in
          ...
          <p>
            The department of sociology has an excellent faculty strength
