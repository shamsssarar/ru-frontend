...
const interrelationsNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of International Relations: Workshop on Documentation and Evidences",
    link: "/academic/department/interrelations/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/interrelations/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/interrelations/notices/3",
  },
];

const interrelationsEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/interrelations/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/interrelations/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/interrelations/events/3",
  },
];

const interrelationsFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/interrelations/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/interrelations/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/interrelations/ex-chairmans",
      },
      { text: "About", url: "/academic/department/interrelations/about" },
      { text: "Contact", url: "/academic/department/interrelations/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/interrelations/iqac" },
      { text: "Thesis", url: "/academic/department/interrelations/thesis" },
      { text: "Committee", url: "/academic/department/interrelations/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/interrelations/faculty-members",
      },
      { text: "Officers", url: "/academic/department/interrelations/officers" },
      { text: "Staff List", url: "/academic/department/interrelations/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/interrelations/journal",
      },
      { text: "Alumni", url: "/academic/department/interrelations/alumni" },
      { text: "Rules & Forms", url: "/academic/department/interrelations/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/interrelations/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/interrelations/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/interrelations/notices" },
      { text: "Events", url: "/academic/department/interrelations/events" },
      { text: "Programs", url: "/academic/department/interrelations/programs" },
      { text: "Photo Gallery", url: "/academic/department/interrelations/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/interrelations/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/interrelations/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/interrelations/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/interrelations/routine",
      },
    ],
  },
  {
...
export default function InternationalRelationsDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of International Relations"
      ...
      profileLink="/academic/department/interrelations/profile"
      notices={interrelationsNotices}
      events={interrelationsEvents}
      departmentName="Department of International Relations"
      footerColumns={interrelationsFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of International Relations is one of the oldest departments in
          ...
          <p>
            The department of international relations has an excellent faculty strength
