...
const mathNotices = [
  {
    ...
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Mathematics: Workshop on Documentation and Evidences",
    link: "/academic/department/math/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/math/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/math/notices/3",
  },
];
...
const mathEvents = [
  {
    ...
    link: "/academic/department/math/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/math/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/math/events/3",
  },
];

const mathFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/math/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/math/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/math/ex-chairmans",
      },
      { text: "About", url: "/academic/department/math/about" },
      { text: "Contact", url: "/academic/department/math/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/math/iqac" },
      { text: "Thesis", url: "/academic/department/math/thesis" },
      { text: "Committee", url: "/academic/department/math/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/math/faculty-members",
      },
      { text: "Officers", url: "/academic/department/math/officers" },
      { text: "Staff List", url: "/academic/department/math/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/math/journal",
      },
      { text: "Alumni", url: "/academic/department/math/alumni" },
      { text: "Rules & Forms", url: "/academic/department/math/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/math/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/math/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/math/notices" },
      { text: "Events", url: "/academic/department/math/events" },
      { text: "Programs", url: "/academic/department/math/programs" },
      { text: "Photo Gallery", url: "/academic/department/math/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/math/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/math/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/math/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/math/routine",
      },
    ],
  },
  {
...
export default function MathematicsDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Mathematics"
      ...
      profileLink="/academic/department/math/profile"
      notices={mathNotices}
      events={mathEvents}
      departmentName="Department of Mathematics"
      footerColumns={mathFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Mathematics is one of the oldest departments in
          ...
          <p>
            The department of mathematics has an excellent faculty strength
