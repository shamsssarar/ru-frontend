...
export default async function FacultyProfilePage({
  ...
  return (
    <div className="w-full bg-[#f9f9f9] min-h-screen flex flex-col">
      ...
      <div className="py-12 px-4 flex-grow">
        <div className="container mx-auto max-w-[900px]">
          <Link
            ...
            className="inline-flex items-center gap-2 text-[#337ab7] hover:text-[#002147] font-bold mb-8 transition-colors"
          >
          ...
          <div className="bg-white shadow-lg rounded-lg overflow-hidden flex flex-col md:flex-row">
            ...
            <div className="w-full md:w-2/3 p-8 md:p-10">
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-[#333333] border-b-2 border-[#d32f2f] pb-2 inline-block mb-4">
                  Biography
                </h2>
              ...
              <div>
                ...
                <div className="flex items-start gap-3">
                  <BookOpen className="w-5 h-5 text-[#337ab7] shrink-0 mt-0.5" />
