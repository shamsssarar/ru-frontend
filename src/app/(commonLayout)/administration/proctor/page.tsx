...
export default function ProctorPage() {
  return (
    <AdministrationSubPageTemplate
      pageTitle="Message from Proctor"
      officialName="DR. Md. Faridul Islam"
      officialTitle="Proctor"
      officialSubtitle="University of Rajshahi"
      officialImage="https://www.ru.ac.bd/wp-content/uploads/2025/08/DJI_20000901124000_0719_D-01-scaled.jpeg"
      profileLink="#"
      footerEntityName="Office of the Proctor"
      notices={proctorNotices}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            ...
            serve as the Proctor of this well known seat of learning. As
            the Proctor of this Institution, I am proud to serve
