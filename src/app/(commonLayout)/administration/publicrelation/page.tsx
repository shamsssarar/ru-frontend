...
export default function PublicRelationPage() {
  return (
    <AdministrationSubPageTemplate
      pageTitle="Message from Public Relations"
      officialName="DR. Md. Faridul Islam"
      officialTitle="Public Relations"
      officialSubtitle="University of Rajshahi"
      officialImage="https://www.ru.ac.bd/wp-content/uploads/2025/08/DJI_20000901123413_0714_D-01-scaled.jpeg"
      profileLink="#"
      footerEntityName="Office of the Public Relations"
      notices={publicrelationNotices}
      events={publicrelationEvents}
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            ...
            serve as the Public Relations of this well known seat of learning. As
            the Public Relations of this Institution, I am proud to serve
