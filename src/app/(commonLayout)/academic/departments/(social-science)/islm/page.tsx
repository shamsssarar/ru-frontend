...
const islmNotices = [
  {
    ...
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Information Science & Library Management: Workshop on Documentation and Evidences",
    link: "/academic/department/islm/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/islm/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/islm/notices/3",
  },
];
...
const islmEvents = [
  {
    ...
    link: "/academic/department/islm/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/islm/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/islm/events/3",
  },
];

const islmFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/islm/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/islm/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/islm/ex-chairmans",
      },
      { text: "About", url: "/academic/department/islm/about" },
      { text: "Contact", url: "/academic/department/islm/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/islm/iqac" },
      { text: "Thesis", url: "/academic/department/islm/thesis" },
      { text: "Committee", url: "/academic/department/islm/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/islm/faculty-members",
      },
      { text: "Officers", url: "/academic/department/islm/officers" },
      { text: "Staff List", url: "/academic/department/islm/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/islm/journal",
      },
      { text: "Alumni", url: "/academic/department/islm/alumni" },
      { text: "Rules & Forms", url: "/academic/department/islm/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/islm/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/islm/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/islm/notices" },
      { text: "Events", url: "/academic/department/islm/events" },
      { text: "Programs", url: "/academic/department/islm/programs" },
      { text: "Photo Gallery", url: "/academic/department/islm/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/islm/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/islm/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/islm/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/islm/routine",
      },
    ],
  },
  {
...
export default function InformationScienceLibraryManagementDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Information Science & Library Management"
      ...
      profileLink="/academic/department/islm/profile"
      notices={islmNotices}
      events={islmEvents}
      departmentName="Department of Information Science & Library Management"
      footerColumns={islmFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Information Science & Library Management is one of the oldest departments in
          ...
          <p>
            The department of information science & library management has an excellent faculty strength
