    ...
    <div className="flex flex-col w-full font-roboto min-h-screen bg-[#f1f1f1]">
      ...
      <section className="w-full py-12 md:py-20">
        <div className="container mx-auto px-4 md:px-0 max-w-[1140px]">
          <div className="bg-white rounded-[3px] shadow-[0px_0px_15px_0px_rgba(0,0,0,0.08)] p-6 md:p-12 border-t-[3px] border-t-[#d32f2f] min-h-[500px]">
            {/* Header Title */}
            <div className="mb-8 md:mb-10">
              <h2 className="text-[24px] md:text-[28px] font-bold text-[#337ab7] uppercase">
                LATEST EVENTS
              </h2>
            </div>
            ...
            <div className="flex flex-col gap-6 md:gap-8">
              {eventsData.map((event) => (
                <div
                  key={event.id}
                  className="flex flex-col md:flex-row bg-white border border-gray-200 rounded-sm overflow-hidden transition-shadow hover:shadow-lg group"
                >
                  ...
                  <div className="flex flex-col justify-center p-6 md:p-8 flex-1">
                    {/* Date */}
                    <div className="flex items-center gap-2 text-gray-500 text-[14px] font-medium mb-3">
                    ...
                    <Link href={`/events/${event.id}`} className="block mb-6">
                      <h3 className="text-[20px] md:text-[24px] font-bold text-[#333333] group-hover:text-[#337ab7] transition-colors leading-snug">
                        {event.title}
                      </h3>
                    </Link>
                    ...
                    <div className="mt-auto">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 text-[#333333] hover:text-[#337ab7] font-bold text-[13px] uppercase tracking-wider transition-colors"
                      >
