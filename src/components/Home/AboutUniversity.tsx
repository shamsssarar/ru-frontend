...
export default function AboutUniversity() {
  return (
    <section className="w-full bg-gray-50 flex items-center justify-center pb-12 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      <div className="container mx-auto px-4 md:px-0 max-w-[1140px]">
        ...
        */}
        <div className="bg-white w-full min-h-[380px] lg:min-h-[211px]
         rounded-[30px] shadow-[0px_0px_10px_0px_rgba(0,0,0,0.5)] flex flex-wrap items-center content-center p-[30px] lg:p-[66px]">
          {/* 
            ...
            - Alignment: text-left
          */}
          <p className="text-[14px] font-roboto font-normal text-[#7A7A7A] leading-[21px] text-left w-full">
