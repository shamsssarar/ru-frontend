...
const lawadminNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Law and Administration: Workshop on Documentation and Evidences",
    link: "/academic/department/lawadmin/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/lawadmin/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/lawadmin/notices/3",
  },
];

const lawadminEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/lawadmin/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/lawadmin/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/lawadmin/events/3",
  },
];

const lawadminFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/lawadmin/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/lawadmin/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/lawadmin/ex-chairmans",
      },
      { text: "About", url: "/academic/department/lawadmin/about" },
      { text: "Contact", url: "/academic/department/lawadmin/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/lawadmin/iqac" },
      { text: "Thesis", url: "/academic/department/lawadmin/thesis" },
      { text: "Committee", url: "/academic/department/lawadmin/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/lawadmin/faculty-members",
      },
      { text: "Officers", url: "/academic/department/lawadmin/officers" },
      { text: "Staff List", url: "/academic/department/lawadmin/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/lawadmin/journal",
      },
      { text: "Alumni", url: "/academic/department/lawadmin/alumni" },
      { text: "Rules & Forms", url: "/academic/department/lawadmin/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/lawadmin/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/lawadmin/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/lawadmin/notices" },
      { text: "Events", url: "/academic/department/lawadmin/events" },
      { text: "Programs", url: "/academic/department/lawadmin/programs" },
      { text: "Photo Gallery", url: "/academic/department/lawadmin/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/lawadmin/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/lawadmin/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/lawadmin/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/lawadmin/routine",
      },
    ],
  },
  {
...
export default function LawandAdministrationDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Law and Administration"
      ...
      profileLink="/academic/department/lawadmin/profile"
      notices={lawadminNotices}
      events={lawadminEvents}
      departmentName="Department of Law and Administration"
      footerColumns={lawadminFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Law and Administration is one of the oldest departments in
          ...
          <p>
            The department of law and administration has an excellent faculty strength
