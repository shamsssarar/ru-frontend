...
export default function TreasurerPage() {
  return (
    <AdministrationSubPageTemplate
      pageTitle="Message from Treasurer"
      officialName="DR. Md. Faridul Islam"
      officialTitle="Treasurer"
      officialSubtitle="University of Rajshahi"
      officialImage="https://www.ru.ac.bd/wp-content/uploads/2025/08/DJI_20000901132204_0762_D-01-scaled.jpeg"
      profileLink="#"
      footerEntityName="Office of the Treasurer"
      notices={treasurerNotices}
      events={treasurerEvents}
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            ...
            serve as the Treasurer of this well known seat of learning. As
            the Treasurer of this Institution, I am proud to serve
