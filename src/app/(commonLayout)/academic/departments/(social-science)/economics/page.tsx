...
const economicsNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Economics: Workshop on Documentation and Evidences",
    link: "/academic/department/economics/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/economics/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/economics/notices/3",
  },
];
...
const economicsEvents = [
  {
    ...
    link: "/academic/department/economics/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/economics/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/economics/events/3",
  },
];

const economicsFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/economics/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/economics/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/economics/ex-chairmans",
      },
      { text: "About", url: "/academic/department/economics/about" },
      { text: "Contact", url: "/academic/department/economics/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/economics/iqac" },
      { text: "Thesis", url: "/academic/department/economics/thesis" },
      { text: "Committee", url: "/academic/department/economics/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/economics/faculty-members",
      },
      { text: "Officers", url: "/academic/department/economics/officers" },
      { text: "Staff List", url: "/academic/department/economics/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/economics/journal",
      },
      { text: "Alumni", url: "/academic/department/economics/alumni" },
      { text: "Rules & Forms", url: "/academic/department/economics/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/economics/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/economics/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/economics/notices" },
      { text: "Events", url: "/academic/department/economics/events" },
      { text: "Programs", url: "/academic/department/economics/programs" },
      { text: "Photo Gallery", url: "/academic/department/economics/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/economics/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/economics/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/economics/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/economics/routine",
      },
    ],
  },
  {
...
export default function EconomicsDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Economics"
      ...
      profileLink="/academic/department/economics/profile"
      notices={economicsNotices}
      events={economicsEvents}
      departmentName="Department of Economics"
      footerColumns={economicsFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Economics is one of the oldest departments in
          ...
          <p>
            The department of economics has an excellent faculty strength
