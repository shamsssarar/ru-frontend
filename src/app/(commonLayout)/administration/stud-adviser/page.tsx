...
export default function StudAdviserPage() {
  return (
    <AdministrationSubPageTemplate
      pageTitle="Message from Student Adviser"
      officialName="DR. Md. Faridul Islam"
      officialTitle="Student Adviser"
      officialSubtitle="University of Rajshahi"
      officialImage="https://www.ru.ac.bd/wp-content/uploads/2025/08/DJI_20000901130704_0733_D-01-scaled.jpeg"
      profileLink="#"
      footerEntityName="Office of the Student Adviser"
      notices={studAdviserNotices}
      events={studAdviserEvents}
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            ...
            serve as the Student Adviser of this well known seat of learning. As
            the Student Adviser of this Institution, I am proud to serve
