...
const mcjNotices = [
  {
    ...
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Mass Communication and Journalism: Workshop on Documentation and Evidences",
    link: "/academic/department/mcj/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/mcj/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/mcj/notices/3",
  },
];
...
const mcjEvents = [
  {
    ...
    link: "/academic/department/mcj/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/mcj/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/mcj/events/3",
  },
];

const mcjFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/mcj/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/mcj/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/mcj/ex-chairmans",
      },
      { text: "About", url: "/academic/department/mcj/about" },
      { text: "Contact", url: "/academic/department/mcj/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/mcj/iqac" },
      { text: "Thesis", url: "/academic/department/mcj/thesis" },
      { text: "Committee", url: "/academic/department/mcj/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/mcj/faculty-members",
      },
      { text: "Officers", url: "/academic/department/mcj/officers" },
      { text: "Staff List", url: "/academic/department/mcj/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/mcj/journal",
      },
      { text: "Alumni", url: "/academic/department/mcj/alumni" },
      { text: "Rules & Forms", url: "/academic/department/mcj/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/mcj/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/mcj/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/mcj/notices" },
      { text: "Events", url: "/academic/department/mcj/events" },
      { text: "Programs", url: "/academic/department/mcj/programs" },
      { text: "Photo Gallery", url: "/academic/department/mcj/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/mcj/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/mcj/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/mcj/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/mcj/routine",
      },
    ],
  },
  {
...
export default function MassCommunicationandJournalismDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Mass Communication and Journalism"
      ...
      profileLink="/academic/department/mcj/profile"
      notices={mcjNotices}
      events={mcjEvents}
      departmentName="Department of Mass Communication and Journalism"
      footerColumns={mcjFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Mass Communication and Journalism is one of the oldest departments in
          ...
          <p>
            The department of mass communication and journalism has an excellent faculty strength
