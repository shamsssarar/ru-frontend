...
const proVcAdministrationNotices = [
  {
    id: 1,
    day: "27",
    month: "MAR",
...
const proVcAdministrationEvents = [
  {
    id: 1,
    date: "05-09-2024",
...
export default function ProVcAdministrationPage() {
  return (
    <AdministrationSubPageTemplate
      pageTitle="Message from Pro Vice-Chancellor (Administration)"
      officialName="DR. Md. Faridul Islam"
      officialTitle="Pro Vice-Chancellor (Administration)"
      officialSubtitle="University of Rajshahi"
      officialImage="https://www.ru.ac.bd/wp-content/uploads/2025/08/DJI_20000901131947_0755_D-02-scaled.jpeg"
      profileLink="#"
      footerEntityName="Office of the Pro Vice-Chancellor (Administration)"
      notices={proVcAdministrationNotices}
      events={proVcAdministrationEvents}
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            ...
            serve as the Pro Vice-Chancellor (Administration) of this well known seat of learning. As
            the Pro Vice-Chancellor (Administration) of this Institution, I am proud to serve
