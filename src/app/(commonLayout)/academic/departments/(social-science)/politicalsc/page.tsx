...
const politicalscNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Political Science: Workshop on Documentation and Evidences",
    link: "/academic/department/politicalsc/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/politicalsc/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/politicalsc/notices/3",
  },
];

const politicalscEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/politicalsc/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/politicalsc/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/politicalsc/events/3",
  },
];

const politicalscFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/politicalsc/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/politicalsc/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/politicalsc/ex-chairmans",
      },
      { text: "About", url: "/academic/department/politicalsc/about" },
      { text: "Contact", url: "/academic/department/politicalsc/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/politicalsc/iqac" },
      { text: "Thesis", url: "/academic/department/politicalsc/thesis" },
      { text: "Committee", url: "/academic/department/politicalsc/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/politicalsc/faculty-members",
      },
      { text: "Officers", url: "/academic/department/politicalsc/officers" },
      { text: "Staff List", url: "/academic/department/politicalsc/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/politicalsc/journal",
      },
      { text: "Alumni", url: "/academic/department/politicalsc/alumni" },
      { text: "Rules & Forms", url: "/academic/department/politicalsc/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/politicalsc/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/politicalsc/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/politicalsc/notices" },
      { text: "Events", url: "/academic/department/politicalsc/events" },
      { text: "Programs", url: "/academic/department/politicalsc/programs" },
      { text: "Photo Gallery", url: "/academic/department/politicalsc/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/politicalsc/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/politicalsc/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/politicalsc/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/politicalsc/routine",
      },
    ],
  },
  {
...
export default function PoliticalScienceDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Political Science"
      ...
      profileLink="/academic/department/politicalsc/profile"
      notices={politicalscNotices}
      events={politicalscEvents}
      departmentName="Department of Political Science"
      footerColumns={politicalscFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Political Science is one of the oldest departments in
          ...
          <p>
            The department of political science has an excellent faculty strength
