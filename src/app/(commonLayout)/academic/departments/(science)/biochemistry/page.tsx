...
const biochemistryNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Biochemistry: Workshop on Documentation and Evidences",
    link: "/academic/department/biochemistry/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/biochemistry/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/biochemistry/notices/3",
  },
];

const biochemistryEvents = [
  {
    id: 1,
    date: "15-07-2026",
    ...
    link: "/academic/department/biochemistry/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/biochemistry/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/biochemistry/events/3",
  },
];

const biochemistryFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/biochemistry/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/biochemistry/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/biochemistry/ex-chairmans",
      },
      { text: "About", url: "/academic/department/biochemistry/about" },
      { text: "Contact", url: "/academic/department/biochemistry/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/biochemistry/iqac" },
      { text: "Thesis", url: "/academic/department/biochemistry/thesis" },
      { text: "Committee", url: "/academic/department/biochemistry/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/biochemistry/faculty-members",
      },
      { text: "Officers", url: "/academic/department/biochemistry/officers" },
      { text: "Staff List", url: "/academic/department/biochemistry/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/biochemistry/journal",
      },
      { text: "Alumni", url: "/academic/department/biochemistry/alumni" },
      { text: "Rules & Forms", url: "/academic/department/biochemistry/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/biochemistry/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/biochemistry/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/biochemistry/notices" },
      { text: "Events", url: "/academic/department/biochemistry/events" },
      { text: "Programs", url: "/academic/department/biochemistry/programs" },
      { text: "Photo Gallery", url: "/academic/department/biochemistry/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/biochemistry/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/biochemistry/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/biochemistry/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/biochemistry/routine",
      },
    ],
  },
  {
...
export default function BiochemistryDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Biochemistry"
      ...
      profileLink="/academic/department/biochemistry/profile"
      notices={biochemistryNotices}
      events={biochemistryEvents}
      departmentName="Department of Biochemistry"
      footerColumns={biochemistryFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Biochemistry is one of the oldest departments in
          ...
          <p>
            The department of biochemistry has an excellent faculty strength
