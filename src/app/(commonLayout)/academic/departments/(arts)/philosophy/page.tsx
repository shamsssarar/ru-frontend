...
const philosophyNotices = [
  {
    id: 1,
    day: "05",
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Philosophy: Workshop on Documentation and Evidences",
    link: "/academic/department/philosophy/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/philosophy/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/philosophy/notices/3",
  },
];
...
const philosophyEvents = [
  {
    ...
    link: "/academic/department/philosophy/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/philosophy/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/philosophy/events/3",
  },
];

const philosophyFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/philosophy/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/philosophy/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/philosophy/ex-chairmans",
      },
      { text: "About", url: "/academic/department/philosophy/about" },
      { text: "Contact", url: "/academic/department/philosophy/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/philosophy/iqac" },
      { text: "Thesis", url: "/academic/department/philosophy/thesis" },
      { text: "Committee", url: "/academic/department/philosophy/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/philosophy/faculty-members",
      },
      { text: "Officers", url: "/academic/department/philosophy/officers" },
      { text: "Staff List", url: "/academic/department/philosophy/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/philosophy/journal",
      },
      { text: "Alumni", url: "/academic/department/philosophy/alumni" },
      { text: "Rules & Forms", url: "/academic/department/philosophy/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/philosophy/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/philosophy/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/philosophy/notices" },
      { text: "Events", url: "/academic/department/philosophy/events" },
      { text: "Programs", url: "/academic/department/philosophy/programs" },
      { text: "Photo Gallery", url: "/academic/department/philosophy/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/philosophy/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/philosophy/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/philosophy/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/philosophy/routine",
      },
    ],
  },
  {
...
export default function PhilosophyDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Philosophy"
      ...
      profileLink="/academic/department/philosophy/profile"
      notices={philosophyNotices}
      events={philosophyEvents}
      departmentName="Department of Philosophy"
      footerColumns={philosophyFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Philosophy is one of the oldest departments in
          ...
          <p>
            The department of philosophy has an excellent faculty strength
