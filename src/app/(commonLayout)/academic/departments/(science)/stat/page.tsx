...
const statNotices = [
  {
    ...
    month: "MAY",
    title:
      "Creating a Roadmap for the Development of the Department of Statistics: Workshop on Documentation and Evidences",
    link: "/academic/department/stat/notices/1",
  },
  {
    id: 2,
    day: "24",
    ...
    link: "/academic/department/stat/notices/2",
  },
  {
    id: 3,
    day: "23",
    ...
    link: "/academic/department/stat/notices/3",
  },
];
...
const statEvents = [
  {
    ...
    link: "/academic/department/stat/events/1",
  },
  {
    id: 2,
    date: "09-07-2026",
    ...
    link: "/academic/department/stat/events/2",
  },
  {
    id: 3,
    date: "18-06-2026",
    ...
    link: "/academic/department/stat/events/3",
  },
];

const statFooterColumns = [
  {
    title: "Footer Menu",
    links: [
      { text: "Message", url: "/academic/department/stat/message" },
      {
        text: "Vision, Mission & Objective",
        url: "/academic/department/stat/vision",
      },
      {
        text: "List of Ex-Chairman",
        url: "/academic/department/stat/ex-chairmans",
      },
      { text: "About", url: "/academic/department/stat/about" },
      { text: "Contact", url: "/academic/department/stat/contact" },
      { text: "Admissions", url: "/admissions" },
      { text: "Student Insurance", url: "#" },
      { text: "IQAC/PSAC/FQAC", url: "/academic/department/stat/iqac" },
      { text: "Thesis", url: "/academic/department/stat/thesis" },
      { text: "Committee", url: "/academic/department/stat/committee" },
    ],
  },
  {
    title: "Quick Links",
    links: [
      {
        ...
        url: "/academic/department/stat/faculty-members",
      },
      { text: "Officers", url: "/academic/department/stat/officers" },
      { text: "Staff List", url: "/academic/department/stat/staff" },
      {
        text: "Research Journal",
        url: "/academic/department/stat/journal",
      },
      { text: "Alumni", url: "/academic/department/stat/alumni" },
      { text: "Rules & Forms", url: "/academic/department/stat/forms" },
      {
        text: "Extra Curriculum",
        url: "/academic/department/stat/extra-curriculum",
      },
      {
        text: "Publications",
        url: "/academic/department/stat/publications",
      },
    ],
  },
  {
    ...
    links: [
      { text: "Notices", url: "/academic/department/stat/notices" },
      { text: "Events", url: "/academic/department/stat/events" },
      { text: "Programs", url: "/academic/department/stat/programs" },
      { text: "Photo Gallery", url: "/academic/department/stat/gallery" },
      {
        text: "Exam Notice",
        url: "/academic/department/stat/exam-notice",
      },
      {
        text: "Citizen Charter",
        url: "/academic/department/stat/citizen-charter",
      },
      {
        text: "Renu Srity Turst",
        url: "/academic/department/stat/renu-srity-trust",
      },
      {
        text: "Class Time Table",
        url: "/academic/department/stat/routine",
      },
    ],
  },
  {
...
export default function StatisticsDepartmentPage() {
  return (
    <DepartmentSubPageTemplate
      pageTitle="Welcome to the Department of Statistics"
      ...
      profileLink="/academic/department/stat/profile"
      notices={statNotices}
      events={statEvents}
      departmentName="Department of Statistics"
      footerColumns={statFooterColumns}
      ...
      messageContent={
        <div className="flex flex-col gap-4">
          <p>
            This Department of Statistics is one of the oldest departments in
          ...
          <p>
            The department of statistics has an excellent faculty strength
